...
urlpatterns = [
    ...
    path('siteallocation/', SiteAllocationListView.as_view(), name='siteallocation-list'),
    path('siteallocation/<int:pk>', SiteAllocationUpdateView.as_view(), name='siteallocation-detail'),
